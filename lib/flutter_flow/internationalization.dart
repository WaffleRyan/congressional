...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  // loginPage
  {
    ...
    'fzxvw3mu': {
      'en': 'Login to your account below',
  ...
  // onboarding
  {
    ...
    'hxtwax0y': {
      'en': 'Look up many different articles',
      'ar':
    ...
    'uf9k1spp': {
      'en': 'FInd tweets by certain people or of a certain hashtag',
    ...
    'q30ina4f': {
      'en':
          'Analyze the hot topics and the general consensus of tweets and articles',
